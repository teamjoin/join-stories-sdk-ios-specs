#
# Be sure to run `pod lib lint join-stories-sdk-ios.podspec` to ensure this is a
...
Provides UI to display stories thumbnails, full screen stories.
  ...
  s.author           = { 'teabow' => 'dimitri@teamjoin.fr' }
  ...
  s.resource_bundles = {
    'join-stories-sdk-ios' => ['Assets/*.jpg']
  }
