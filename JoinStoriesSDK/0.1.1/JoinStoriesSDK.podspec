...
Provides UI to display stories thumbnails, full screen stories.
  ...
  s.public_header_files = "JoinStoriesSDK.framework/Headers/*.h"
  s.source_files = "JoinStoriesSDK.framework/Headers/*.h"
  s.vendored_frameworks = "JoinStoriesSDK.framework"
